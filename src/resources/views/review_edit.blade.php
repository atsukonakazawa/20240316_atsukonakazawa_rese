    ...
    <div class="content">
        ...
        @csrf
            ...
            <div class="comment-outer">
                ...
                <textarea class="comment" name="comment" id="review" cols="30" rows="5" placeholder="カジュアルな夜のお出かけにおすすめのスポット">{{ $already ? $already->comment : old('comment') }}</textarea>
                <p class="count">
                    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                    <span id="charCount">{{ $already ? strlen($already->comment) : 0 }}</span>/400(最高文字数)
                </p>
                <script>
                    $(document).ready(function() {
                        // ページロード時に初期の文字数をカウントして表示
                        var initialCharCount = $('#review').val().length;
            ...
            <div class="review-img__outer">
                ...
                <div class="review-img">
                    ...
                    <div id="preview">
                        ...
                        <img src="{{ asset('storage/' . $already->review_img) }}" style="max-width: 200px; margin-top: 10px;">
                        @endif
                    </div>
                </div>
